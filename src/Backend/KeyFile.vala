 ...
 */
public class Workspaces.Backend.KeyFile : GLib.Object {
    ...
    private string create_path_for_custom_command () {
        var startup_dir = Workspaces.Utils.get_user_startup_dir ();
    ...
    public Workspaces.Models.AppInfo create_app_info () {
        
        print ("-- Creating app info %s --\n", path);
        print ("Name:    %s\n", keyfile_get_locale_string (KeyFileDesktop.KEY_NAME));
        print ("Comment: %s\n", keyfile_get_locale_string (KeyFileDesktop.KEY_COMMENT));
        print ("Command: %s\n", keyfile_get_string (KeyFileDesktop.KEY_EXEC));
        print ("Icon:    %s\n", keyfile_get_string (KeyFileDesktop.KEY_ICON));
        print ("Active:  %s\n", active.to_string ());
        print ("-- Done --\n");

        return new Workspaces.Models.AppInfo (
            keyfile_get_locale_string (KeyFileDesktop.KEY_NAME), 
            keyfile_get_string (KeyFileDesktop.KEY_ICON), 
            keyfile_get_string (KeyFileDesktop.KEY_EXEC), 
            keyfile_get_string (KeyFileDesktop.KEY_ICON)
